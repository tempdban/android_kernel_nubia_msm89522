...
#ifndef _CYTTSP568_REGS_H
#define _CYTTSP568_REGS_H
...
#define CYTTSP568_TTHE_TUNER_FILE_NAME "tthe_tuner"
#endif
...
/*gesture id*/
#define GESTURE_DOUBLE_CLICK 0x0022
#define GESTURE_LETTER_c 0x0163
#define GESTURE_LETTER_e 0x0165
#define GESTURE_LETTER_m 0x016D
#define GESTURE_LETTER_w 0x0177
#define GESTURE_LETTER_o 0x0147 //temp define
#define GESTURE_LETTER_v 0x0176
#define GESTURE_LETTER_z 0x017A

#define GESTURE_SLIDE_NORTH 0x0080
#define GESTURE_SLIDE_EAST  0x0084
#define GESTURE_SLIDE_SOUTH 0x0088
#define GESTURE_SLIDE_WEST  0x008C
#endif
...
#ifdef ZTE_GES_WAKEUP
struct cyttsp5_gesture_position {
	int x;
	int y;
};
#endif
...
struct cyttsp5_core_data {
    ...
    struct workqueue_struct *cyttsp5_wq;
...
#define CYTTSP568_PREALLOCATED_CMD_BUFFER 32
	u8 cmd_buf[CYTTSP568_PREALLOCATED_CMD_BUFFER];
...
#ifdef CONFIG_TOUCHSCREEN_CYPRESS_CYTTSP568_DEVICETREE_SUPPORT
...
/*** ZTEMT start 20141219 sleeping mode ***/
int cyttsp5_resume_attention(struct cyttsp5_core_data *cd);
/*** ZTEMT end ***/
...
#ifdef CONFIG_TOUCHSCREEN_CYPRESS_CYTTSP568_BUTTON
...
#ifdef CONFIG_TOUCHSCREEN_CYPRESS_CYTTSP568_PROXIMITY
